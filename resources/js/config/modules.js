...
export const modules = {
    ...
    clients: {
        ...
        fields: [
            ...
            { key: 'city', label: 'Ville' }, { ...status([]), referenceGroup: 'client_status' },
    ...
    leads: {
        ...
        fields: [
            { key: 'name', label: 'Nom', required: true }, { key: 'company', label: 'Société' },
            { key: 'email', label: 'E-mail', type: 'email' }, { key: 'phone', label: 'Téléphone' },
            { key: 'source', label: 'Source', type: 'select', options: [], referenceGroup: 'lead_source' }, { key: 'value', label: 'Valeur estimée', type: 'number' },
            { ...status([]), referenceGroup: 'lead_status' },
            { key: 'notes', label: 'Notes', type: 'textarea', wide: true },
        ],
    ...
    quotes: {
        ...
        columns: [['reference', 'Référence'], ['lead.name', 'Prospect'], ['client.name', 'Client'], ['total', 'Total (DT)'], ['valid_until', 'Validité'], ['status', 'Statut']],
        fields: [
            { key: 'reference', label: 'Référence', required: true }, { key: 'client_id', label: 'ID client', type: 'number' },
            { key: 'lead_id', label: 'ID prospect', type: 'number' },
            ...
            { ...status([]), referenceGroup: 'quote_status' },
            { key: 'notes', label: 'Notes', type: 'textarea', wide: true },
        ],
    ...
    tasks: {
        ...
        fields: [
            ...
            { ...status([]), referenceGroup: 'task_status' },
            { key: 'priority', label: 'Priorité', type: 'select', required: true, options: [], referenceGroup: 'task_priority' },
    ...
    inquiries: {
        ...
        fields: [
            ...
            { ...status([]), referenceGroup: 'inquiry_status' },
