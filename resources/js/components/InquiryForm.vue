...
const form = reactive({ type: props.type, firstName: '', lastName: '', email: '', phone: '', company: '', subject: '', message: '', website: '' });
...
async function submit() {
    ...
    try {
        ...
        Object.assign(form, { type: props.type, firstName: '', lastName: '', email: '', phone: '', company: '', subject: '', message: '', website: '' });
    } catch (error) {
